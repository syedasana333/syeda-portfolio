...
const Hero = () => {
    return ( 
        <main>
            <img src={logo} className="logo" alt="image of syeda-logo"/>
            ...
            <p className="about"> I've spent the past <b> 2 years </b> learning everything I can about UI/UX, from the basics of wireframing to the complexities of user research. Throughout my career in <b>UX design,</b> I've collaborated with startups, established organizations, and worked with teams across various sectors.</p>
